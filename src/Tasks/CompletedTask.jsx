...
function CompletedTask({data}) {
    return (
        <div className=' flex-shrink-0 h-full w-[320px] bg-orange-700  rounded-xl p-5'>
            ...
            <div className='flex justify-between mt-4'>
                <button className='px-3 py-4 bg-green-600  text-sm border-none rounded text-white font-semibold'>Mark as failed</button>
                <button className='px-3 py-4 bg-red-600 text-sm rounded border-none text-white font-semibold'>Mark as active</button>
            </div>
        </div>
    )
}
